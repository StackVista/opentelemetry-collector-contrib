...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/splunkhecexporter v0.133.1
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/ackextension v0.133.1
