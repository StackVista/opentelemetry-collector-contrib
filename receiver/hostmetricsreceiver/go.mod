...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.133.1
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.133.1
	...
	go.opentelemetry.io/collector/scraper/scrapertest v0.133.0
