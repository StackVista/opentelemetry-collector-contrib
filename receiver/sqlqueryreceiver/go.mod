...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage v0.133.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.133.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sqlquery v0.133.1
