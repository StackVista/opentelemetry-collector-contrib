...
require (
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/grpcutil v0.133.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/otelarrow v0.133.1
